        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-info" href="javascript:void(0)" id="createNewCabang"><i class="fa fa-plus-circle"> Tambah
                            Cabang</i></a>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="NamaCabang" name="NamaCabang"
                                    placeholder="Masukan nama cabang" value="" maxlength="50" required="">
