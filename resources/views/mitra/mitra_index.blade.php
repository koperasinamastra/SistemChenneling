        ...
        <div class="col-12">
             <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-info" href="javascript:void(0)" id="createNewMitra"><i class="fa fa-plus-circle"> Tambah Mitra</i></a>
                    ...
                    <form id="mitraForm" name="mitraForm" class="form-horizontal">
                       <input type="hidden" name="mitra_id" id="mitra_id">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="NamaMitra" name="NamaMitra" placeholder="Enter Name" value="" maxlength="50" required="">
    ...
    if (result.isConfirmed) {
        ...
        $.ajax({
            ...
            success:function(response){ 
                ...
                window.LaravelDataTables["tabelmitra"].ajax.reload()
